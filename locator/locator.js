const navigation = {
    car_news_x: '//html/body/header/div/div[2]/div[1]/ul/a/li[1]',
    car_news: '車壇新訊',
    local_news: '國內要聞',
    global_news: '國際車訊',
    analysis: '銷售分析',
    ...
    spy_shot: '間諜照',
    promotion: '促銷優惠',
    video_x: '//html/body/header/div/div[2]/div[2]/ul/a/li[1]',
    video: '影音',
    tv_show: '節目完整版',
    essence: '節目精華',
    roadtest_video: '試駕影音',
    liveview: '現場直擊',
    life_x: '//html/body/header/div/div[2]/div[3]/ul/a/li[1]',
    life: '交通生活',
    car_life: '生活時事',
    hot: '熱搜話題',
    policy: '政策法規',
    tech: '科技時尚',
    celebrity_x: '//html/body/header/div/div[2]/div[4]/ul/a/li[1]',
    celebrity: '名人與車',
    talent: '達人說車',
    people_story: '人車故事',
    artist: '藝起當老司機',
    report_x: '//html/body/header/div/div[2]/div[5]/ul/a/li[1]',
    report: '試駕報導',
    car_roadtest: '汽車試駕',
    electric: '電車試駕',
    bike_roadtest: '二輪試駕',
